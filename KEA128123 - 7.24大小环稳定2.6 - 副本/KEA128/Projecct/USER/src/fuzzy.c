...
void fuzzy_deal(float offset,float offset_rate)
{
    ...
    int err,err_rate;
    int dat,i;
    float err_rule[7] = {0.0,6.0,10.0,15.0,21.0,28.0,35.0};        //偏差特征值
    float err_rate_rule[7] = {0.0,0.8,1.9,3.7,5.4,7.2,10.0}; //偏差变化率特征值
    
    
    float p_count[7] = {1.08,1.11,1.15,1.18,1.22,1.28,1.32};       //P隶属函数中心值
  ...
  //ec 0 1 2 3 4 5 6  //e
   ...
   //  printf("%d",(int)(fuzzy_p*Direction_P));     printf(",");    printf("%d\n",(int)fuzzy_d);
}
